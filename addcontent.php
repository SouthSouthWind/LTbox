                ...
                <div class="span12">
                    ...
                    <div class="widget gray">
                        <div class="widget-title">
                            <h4><i class="icon-reorder" style="background:gray;"></i> 添加内容 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body" style="border-color:gray;">
                            ...
                            <form action="#" class="form-horizontal" id="addcontentform">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span4 " data-placeholder="Choose a Category" name="cate_id_parent" id="cate_id_parent" tabindex="1">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span4 " data-placeholder="Choose a Category" name="cate_id_child" id="cate_id_child" tabindex="1">
                                            <option value="0">请选择</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="title" name="goods_name" class="span4 " />
                               ...
                               <div class="control-group">
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="model" name="model" class="span4 " />
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="goods_price" name="goods_price" class="span4 " />
                                 ...
                                 <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="goods_total" name="goods_total" class="span4 " />
                                        <span class="help-inline">必填</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="detail" name="detail" class="span10 " />this is default information</textarea>
                                        <span class="help-inline"></span>
                                    </div>
                                </div>
